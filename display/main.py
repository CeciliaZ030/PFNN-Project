...
class Test(ShowBase):
	...
	def __init__(self):
		...
		posInterval1 = self.pandaActor.posInterval(2, Point3(0, -10, 0), startPos=Point3(0, 10, 0))
		posInterval2 = self.pandaActor.posInterval(2, Point3(0, 10, 0), startPos=Point3(0, -10, 0))
